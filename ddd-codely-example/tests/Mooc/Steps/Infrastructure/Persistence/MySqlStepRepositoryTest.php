...
final class MySqlStepRepositoryTest extends StepsModuleInfrastructureTestCase
{
	 ...
	 * @dataProvider steps
	 */
	public function it_should_save_an_step(AbstractStepAG $step): void
	{
	 ...
	 * @dataProvider steps
	 */
	public function it_should_search_an_existing_step(AbstractStepAG $step): void
	{
		$this->repository()->save($step);
	 ...
	 * @dataProvider steps
	 */
	public function it_should_delete_an_existing_step(AbstractStepAG $step): void
	{
		$this->repository()->save($step);
