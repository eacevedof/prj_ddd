...
use CodelyTv\Mooc\Courses\Application\Create\CourseCreatorService;
...
final class CreateCourseCommandHandlerTest extends CoursesModuleUnitTestCase
{
	...
	protected function setUp(): void
	{
		...
		$this->handler = new CreateCourseCommandHandler(new CourseCreatorService($this->repository(), $this->eventBus()));
	}
