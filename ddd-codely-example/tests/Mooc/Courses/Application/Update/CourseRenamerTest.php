...
use CodelyTv\Mooc\Courses\Application\Update\CourseRenamerService;
...
{
	private CourseRenamerService | null $renamer;

	protected function setUp(): void
	{
		parent::setUp();

		$this->renamer = new CourseRenamerService($this->repository(), $this->eventBus());
	}
