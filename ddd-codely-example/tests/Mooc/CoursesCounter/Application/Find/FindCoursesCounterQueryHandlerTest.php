...
use CodelyTv\Mooc\CoursesCounter\Application\Find\CoursesCounterFinderService;
...
final class FindCoursesCounterQueryHandlerTest extends CoursesCounterModuleUnitTestCase
{
	...
	protected function setUp(): void
	{
		...
		$this->handler = new FindCoursesCounterQueryHandler(new CoursesCounterFinderService($this->repository()));
	}
	...
	public function it_should_throw_an_exception_when_courses_counter_does_not_exists(): void
	{
		...
		$this->assertAskThrowsException(CoursesCounterNotExistException::class, $query, $this->handler);
	}
}
