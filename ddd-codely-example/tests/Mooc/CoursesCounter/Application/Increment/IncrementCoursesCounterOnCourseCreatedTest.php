...
use CodelyTv\Mooc\CoursesCounter\Application\Increment\CoursesCounterIncrementerService;
...
final class IncrementCoursesCounterOnCourseCreatedTest extends CoursesCounterModuleUnitTestCase
{
	...
	protected function setUp(): void
	{
		...
		$this->subscriber = new IncrementCoursesCounterOnCourseCreated(
			new CoursesCounterIncrementerService($this->repository(), $this->uuidGenerator(), $this->eventBus())
		);
	}
