...
final class PublishDomainEventsFromMutationsCommand extends Command
{
	...
	private function findTransformer(string $tableName, string $operation): ?DatabaseMutationToDomainEventInterface
	{
		...
		/** @var class-string<DatabaseMutationToDomainEventInterface>|null $class */
